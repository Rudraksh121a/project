...
def data_get():
    city=city_name.get()
    data=requests.get("https://api.openweathermap.org/data/2.5/weather?q="+city+"&appid=f7a9acf29f467822e104f95f5a071e91").json()
...
win.title("Rudrsksh")
win.config(bg="blue")
win.geometry("500x570")  # it give size of the box or display


# create the upper box
name_label=Label(win,text="Rudraksh Weather App",
...
com=ttk.Combobox(win,text="Rudraksh",values=list_name,font=("Time New Roman",20,"bold"),textvariable=city_name)
